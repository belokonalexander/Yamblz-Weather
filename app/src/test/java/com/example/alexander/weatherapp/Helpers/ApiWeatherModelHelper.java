...
public class ApiWeatherModelHelper {
    ...
    public static WeatherResponseModel getWeatherModel() {
        return getModelFromJSON(WeatherResponseModel.class, getDefaultJSON());
    }

    public static WeatherResponseModel getWeatherModel(Modify... modify) {
        return getModelFromJSON(WeatherResponseModel.class, getAlteredWeatherModel(modify));
    }
