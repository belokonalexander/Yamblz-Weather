...
public class ForecastModule {
    ...
    @Provides
    @ForecastScope
    ForecastInteractor provideForecastInteractor(WeatherAPI weatherApi, StorageRepository storageRepository, RxMapper mapper) {
        return new ForecastInteractor(weatherApi, storageRepository, mapper);
    }
